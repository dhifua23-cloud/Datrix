            ...
            {!collapsed && (
              <div className="flex items-center gap-3">
                ...
                <div className="min-w-0">
                  ...
                  <p className="text-[9px] text-gray-400 dark:text-gray-500 leading-tight">{BRAND.tagline}</p>
                </div>
              </div>
            )}
            <div className={`flex items-center gap-1 ${collapsed ? 'w-full justify-center' : ''}`}>
              <button onClick={() => setCollapsed(!collapsed)} className="text-gray-400 hover:text-gray-600 text-lg p-1" title={collapsed ? 'Tampilkan menu' : 'Sembunyikan menu'}>
              ...
              <button onClick={onClose} className="lg:hidden text-gray-400 hover:text-gray-600 text-lg p-1">✕</button>
            </div>
          </div>
        </div>
